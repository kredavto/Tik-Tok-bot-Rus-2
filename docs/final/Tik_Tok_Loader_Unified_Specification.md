...
Queue retry and duplicate-prevention rules are defined in [Queue and Retry Policy](#51-queue-and-retry-policy).

Temporary file handling is defined in [File Storage Policy](#50-file-storage-policy).
